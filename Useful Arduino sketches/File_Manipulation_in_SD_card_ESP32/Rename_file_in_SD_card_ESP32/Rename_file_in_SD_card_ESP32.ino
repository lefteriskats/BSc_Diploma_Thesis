...
char* filePathBefore = "/data.csv";
char* filePathAfter = "/new.txt";

//char* filePathBefore = "/new.txt";
//char* filePathAfter = "/data.csv";
...
void setup() {
  ...
  renameFile(SD, filePathBefore, filePathAfter);
